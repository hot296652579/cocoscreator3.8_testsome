...
export class EditableTorus extends Component {
    ...
    private torusModel: ModelComponent;

    onLoad() {
        this.torusModel = this.getComponent(ModelComponent);
        if (this.torusModel == null) this.torusModel = this.addComponent(ModelComponent);
        this.rebuildModel();
    }
    ...
    private rebuildModel() {
        ...
        if (this.torusModel.mesh) this.torusModel.mesh.destroy();
        this.torusModel.mesh = mesh;
    }

    onDestroy() {
        if (this.torusModel.mesh) {
            this.torusModel.mesh.destroy();
            this.torusModel.mesh = null;
        }
    }
}
